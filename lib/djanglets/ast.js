...
Ast = {
   ...
   * @return {bool}
   */
  getCurrentBool: function () {
    return this.state.booleanStack[this.state.booleanStack.length - 1];
  },
  /**
   * @return {bool}
   */
  getPreviousBool: function () {
    return this.state.booleanStack[this.state.booleanStack.length - 2];
  },
  /**
   * @return {bool}
   */
  getHeadBool: function () {
    return this.state.booleanStack[0];
  },
  clearBoolStack: function () {
    this.state.booleanStack = [];
  },
  /**
   * @param {bool} bool
   */
  addBool: function (bool) {
    var current, prev;
    current = this.getCurrentBool();
    this.state.booleanStack.push(bool);
    prev = this.getPreviousBool();
  },
  states: {
    INITIAL: "INITIAL",
    ELEMENT: "ELEMENT",
...
visitor = {
   ...
   * @param {*=} opt_b
   */
  visitBooleanExpression: function (ast, not, a, opt_op, opt_b) {
    //console.log("visitBooleanExpression", arguments);
  },
  /**
