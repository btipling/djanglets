...
/***/ function(module, exports, __webpack_require__) {
	...
	function createVariable(name) {
	  ...
	  variable = Object.create(Variable, {
	    ...
	    toString: {
	      value: function (opt_data) {
	        var result = "" + utils.getVariable(name, opt_data || {});
	        if (Error.prototype.isPrototypeOf(result)) {
	          return "";
	        }
	                ...
	                case "[object Object]":
	                  ...
	                  keys.forEach(function (key) {
	                    ...
	                    results = results.concat(this.children.map(function (child) {
	                      var result;
	                      result = child.toString(childData, "" + (opt_id || "") + "." + idCount);
	                      return result;
	                    }));
	                    idCount++;
	                  }, this);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	function getVariable (name, data) {
	  var result;
	  if (data.hasOwnProperty(name)) {
	    return data[name];
	  }
	  if (data.context) {
	    return getVariable(name, data.context);
	  }
